                ...
                <div className="flex-[55%] py-12 md:py-0 bg-[#FFFFFF] md:bg-[#FFFFFF]">
                    <div className="hidden md:flex items-center py-14 pl-13 pr-36">
                        ...
                        <div className="flex w-20 items-center justify-center">
                            <button className="btn btn-sm bg-[#FFBA33] w-40 h-10 rounded-2xl font-bold text-[#6A4029] hover:bg-[#F49D1A]">Sign Up</button>
                        </div>
                    </div>
                    <form className="flex flex-col items-center gap-5">
                        ...
                        <div className="w-[25rem] mt-7">
                            <button type="submit" className="btn btn-signup bg-[#FFBA33] text-[#6A4029] font-bold text-lg rounded-2xl hover:bg-[#F49D1A]">Login</button>
                        </div>
                        <div className="w-[25rem]">
