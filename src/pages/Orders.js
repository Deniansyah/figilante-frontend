      ...
      <div className="w-full px-[10%] py-[5%]">
        ...
        <div className="flex items-start gap-[30px] justify-between">
          <section className="w-[40%]">
            <div className='bg-white px-5 py-[50px] rounded-[8px] font-semibold text-[17px]'>
            <p className="text-[25px] font-semibold mb-[20px] text-center">
              Delivery Order<br/>
              <span className='text-[18px] font-normal'>for Zulaikha</span>
            </p>
            ...
            <button className='btn btn-warning btn-block mt-[30px]'>Swipe up to see upcoming orders</button>
          </section>
